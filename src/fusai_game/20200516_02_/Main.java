...
//		outWeight = new int[n][out_max];
		...
		nodeRF = new String[n];
		reachable = new int[n];
		sb[3] = new StringBuilder(3*3*5000000);
	    sb[4] = new StringBuilder(4*4*5000000);
	    sb[5] = new StringBuilder(5*5*10000000);
	    sb[6] = new StringBuilder(6*6*20000000);
	    sb[7] = new StringBuilder(7*7*30000000);
	    sb[8] = new StringBuilder(8*8*30000000);
		int count_i=0;

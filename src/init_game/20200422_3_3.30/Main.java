...
public class Main {
	...
	public static void main(String[] args) {
		...
		SerachCricleThread r0 = new SerachCricleThread(gs, 0, sampleNum/50);
		SerachCricleThread r1 = new SerachCricleThread(gs, sampleNum/50, sampleNum/20);
		SerachCricleThread r2 = new SerachCricleThread(gs, sampleNum/20, sampleNum/11);

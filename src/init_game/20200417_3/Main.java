...
public class Main {
	...
	public static void main(String[] args) {
		...
		SerachCricleThread r2 = new SerachCricleThread(gs, sampleNum/30, sampleNum/15);
		SerachCricleThread r3 = new SerachCricleThread(gs, sampleNum/15, sampleNum/8);
		SerachCricleThread r4 = new SerachCricleThread(gs, sampleNum/8, sampleNum/5);
		SerachCricleThread r5 = new SerachCricleThread(gs, sampleNum/5, sampleNum);

...
public class Main {
	...
	public static void main(String[] args) {
		...
		SerachCricleThread r1 = new SerachCricleThread(gs, 0, sampleNum/10);
		SerachCricleThread r2 = new SerachCricleThread(gs, sampleNum/10, sampleNum);
		exe.execute(r1);
		exe.execute(r2);
		exe.shutdown();
		while (true) {
		...
		int circleCount =circleCount_r1[0]+ circleCount_r2[0];
